...
export default class ImagePickerEdit extends Component {
  ...
  pickVideo(){
    ImagePicker.openPicker({
      ...
      console.log(video);
      this.setState({
        image: {uri: video.path,mime:'video/mp4'}
      });
    }).catch(e => alert(e));
  }
  ...
  render() {
    return (<View style={styles.container}>
      ...
      <TouchableOpacity onPress={this.pickVideo.bind(this)} style={styles.button}>
