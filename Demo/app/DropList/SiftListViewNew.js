...
export default class SiftListViewNew extends Component {
    ...
    _renderButton = ()=> {
        ...
        // let icon = showDropdown?require('../images/btn_enter.sv'):require('../images/btn_down.svg');
        let icon = showDropdown?require('../../app/busi_sel@2x.png'):require('../../app/busi_sel@2x.png');
                            ...
                            <View style={[frameStyle,styles.dropdown,{height:item.list?30*item.list.length:0},{width:style.width}]}>
                                {
                                    ...
                                    return(
                                        <TouchableOpacity
                                            ...
                                            key={i}
                                        >
                                            <View style={[styles.listCellStyle,{width:style.width-1},selectedIndex===i&&styles.listCellS]}
                                            >
...
const styles = StyleSheet.create({
    button: {
        ...
        flexDirection:'row',
        height:32,
        borderRightColor:System_styles.hei_12,
        borderRightWidth:0.5,
        borderBottomColor:System_styles.hei_12,
    ...
    dropdown: {
        ...
        borderRightColor:System_styles.hei_12,
        borderRightWidth:0.5,
        borderLeftColor:System_styles.hei_12,
        borderLeftWidth:0.5,
    },
    loading: {
        alignSelf: 'center',
    ...
    listCellS:{
        backgroundColor:System_styles.hei_240
    },
});
